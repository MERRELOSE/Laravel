...
<div class="container mt-5">
    <header class="text-center mb-5">
        ...
        <a href="{{ route('articles.create') }}" class="btn btn-success btn-lg me-2">Créer un article</a>
        <a href="{{ route('articles.index') }}" class="btn btn-outline-primary btn-lg">Voir les articles</a>
    </header>
    ...
    <section class="my-5 py-5 bg-light rounded shadow-sm">
        <div class="row align-items-center">
            ...
            <div class="col-md-6">
                <img src="{{ asset('images/people.jpeg') }}" alt="Communauté" class="img-fluid rounded shadow">
            </div>
        </div>
    </section>
    ...
    <section class="text-center my-5">
        ...
        <a href="{{ route('articles.create') }}" class="btn btn-success btn-lg">Créer un article</a>
    </section>

    <footer class="bg-dark text-white text-center py-3 mt-5">
        <p>&copy; {{ date('Y') }} YourBlog. Tous droits réservés. Designed by Kennedy Merrelose</p>
        <p>
